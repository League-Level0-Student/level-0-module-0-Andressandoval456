...
public class MadlibsOfTheAmazon {
	...
	String adective = JOptionPane.showInputDialog("enter adjective");
		// Get the player to enter a type of liquid
	String liquid = JOptionPane.showInputDialog("Enter Liquid");
		// Get the player to enter a body part
	String bodypart = JOptionPane.showInputDialog("Enter Body Pat");
	...
	String place = JOptionPane.showInputDialog("Enter Place");
		...
		String story = 
		"Piranhas are more "+adective+" during the day, so cross the river at\n"  +
